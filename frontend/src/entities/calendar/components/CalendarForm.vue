...
const myEvents = ref<MbscCalendarEvent[]>([
    {
        id: 1,
        start: '2025-04-08T13:00',
        end: '2025-04-08T13:45',
    ...
    {
        id: 2,
        start: '2025-04-08T15:00',
        end: '2025-04-08T16:00',
        title: 'Conference',
        description: '',
        allDay: false,
        bufferBefore: 30,
    ...
    {
        id: 4,
        start: '2025-04-09T10:30',
        end: '2025-04-09T11:30',
    ...
    >
        ...
        <div class="mbsc-form-group">
            ...
            >
                ...
                <div
                    class="event-color"
                    :style="{ background: popupEventColor }"
                ></div>
            </div>
