...
//     route: (loungeId: string, itemId: string | number) => string;
...
//         route: (loungeId, itemId) => `/lounge/${loungeId}/channel/${itemId}`,
//         enabled: true,
//         paramName: 'channelId',
//     },
//     calendar: {
...
//         route: (loungeId, itemId) => `/lounge/${loungeId}/calendar/${itemId}`,
//         enabled: true,
...
//         fetchItems: async () => [],
//         findFirst: () => null,
//         route: (loungeId, itemId) => `/lounge/${loungeId}/post/${itemId}`,
...
//         fetchItems: async () => [],
//         findFirst: () => null,
//         route: (loungeId, itemId) => `/lounge/${loungeId}/note/${itemId}`,
//         enabled: false, // 아직 구현 안됨
//         paramName: 'noteId',
//     },
...
//         // 마지막 접속 아이템 ID 가져오기
//         const lastActiveItemId = loungeStore.activeItems[loungeId]?.[itemType];

//         if (lastActiveItemId !== null && lastActiveItemId !== undefined) {
//             // 마지막 접속 아이템이 있으면 해당 아이템으로 이동
//             router.push(api.route(loungeId, lastActiveItemId));
//         } else {
...
//             if (firstItemId !== null) {
//                 // 첫 번째 아이템으로 이동
//                 router.push(api.route(loungeId, firstItemId));
...
//     itemType: string,
// ): ((loungeId: string, itemId: string | number) => string) | null {
