<template>
    <div
        ...
        :style="{ width: 'var(--custom-lounge-list-width)' }"
    >
        <!-- 최상단 홈 아이콘 바 -->
        <div
        ...
        <div class="scroll-wrapper relative flex-1 min-h-0">
            ...
            <div ref="scrollContainer" class="lounge-list-scroll">
                <div class="flex flex-col items-center gap-2 w-full">
                    <LoungeIconList />
                    <div
                        class="relative flex items-center justify-center w-full group cursor-pointer"
                        @click="handleNewLoungeClick"
                    >
                        <div
...
import { LoungeIconList } from '@/entities';
...
.lounge-list-scroll::-webkit-scrollbar {
    display: none;
}
